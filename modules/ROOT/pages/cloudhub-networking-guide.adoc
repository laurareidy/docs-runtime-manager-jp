...
|===
|DNS レコード |リージョン
| `myapp.us-e1.cloudhub.io` | 米国東部 (北バージニア)
| `myapp.us-e2.cloudhub.io` | 米国東部 (オハイオ)
| `myapp.us-w1.cloudhub.io` | 米国西部 (北カリフォルニア)
| `myapp.us-w2.cloudhub.io` | 米国西部 (オレゴン)
| `myapp.ca-c1.cloudhub.io` | カナダ (中央部)
| `myapp.br-s1.cloudhub.io` | 南米 (サンパウロ)
| `myapp.sg-s1.cloudhub.io` | アジア太平洋 (シンガポール)
| `myapp.au-s1.cloudhub.io` | アジア太平洋 (シドニー)
| `myapp.jp-e1.cloudhub.io` | アジア太平洋 (東京)
| `myapp.ir-e1.cloudhub.io` | EU (アイルランド)
| `myapp.de-c1.cloudhub.io` | EU (フランクフルト)
| `myapp.uk-e1.cloudhub.io` | EU (ロンドン)
