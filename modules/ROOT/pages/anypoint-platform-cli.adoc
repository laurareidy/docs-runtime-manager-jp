...
Anypoint-CLI は、NodeJS アプリケーションです。Anypoint Platform CLI をコンピュータにインストールするには、NPM (デフォルトの NodeJS パッケージマネージャ) と共に NodeJS ランタイム環境がコンピュータにインストールされていることを確認する必要があります。
