...
[TIP]
====
サポートされているすべてのリソース、メソッド、必須プロパティ、予想される応答の対話型リファレンスについては、CloudHub API の https://anypoint.mulesoft.com/apiplatform/anypoint-platform/#/portals/organizations/68ef9520-24e9-4cf2-b2f5-620025690913/apis/8617/versions/2321502/pages/107964[API ポータル]を参照してください。
====
