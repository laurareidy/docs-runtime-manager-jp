...
API を使用する場合、任意の https://jersey.github.io/[JSON をデータ形式]として使用できます。https://jersey.github.io/[Java を使用する場合、JSON 用の https://github.com/codehaus/jackson[Jackson] がサポートされている https://jersey.github.io/[Jersey クライアント]または http://hc.apache.org/httpclient-3.x/index.html[HttpClient] を使用することをお勧めします。
